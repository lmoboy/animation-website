                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        ...
                        <div className="hidden sm:flex sm:items-center sm:ms-6">
                            <div className="inline-flex items-center p-1 bg-gradient-to-r from-purple-900 to-blue-900 text-white rounded-lg transform hover:scale-105 transition-all duration-300 mt-2">
                                {user.points}
                            </div>
