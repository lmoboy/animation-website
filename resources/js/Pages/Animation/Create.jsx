...
export default function Create({ auth }) {
    ...
    const applyAnimation = () => {
        ...
        Object.entries(toolSettings).forEach(([property, value]) => {
            ...
            if (["easing", "loop", "direction", "duration"].includes(property))
                return;
            ...
            const animationProperty =
                property === "radius" ? "borderRadius" : property;
                ...
                const animeAnimation = anime({
                    ...
                    update: function (anim) {
                        ...
                        const previousDuration = animations
                            ...
                            .reduce(
                                (total, a) => total + (a.duration || 1000),
                                0
                            );

                        const currentProgress =
                            (anim.progress / 100) * duration;
                        const overallProgress =
                            ((previousDuration + currentProgress) / totalTime) *
                            100;
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            if (timeline.length === 0) {
                throw new Error(
                    "Please add at least one animation to the timeline"
                );
            }
            if (
            ...
            router.post(
                ...
                },
                {
                    ...
                    onError: (errors) => {
                        ...
                        setToastMessage(
                            firstError ||
                                "An error occurred while saving the animation"
                        );
                        setToastType("error");
                        setShowToast(true);
                    },
    ...
    const handleDeleteAnimation = () => {
        if (confirm("Are you sure you want to delete this animation?")) {
            // Replace with actual API call to delete the animation
        ...
        <AuthenticatedLayout user={auth.user}>
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 relative overflow-hidden">
                        {/* Tools */}
                        <Tools
